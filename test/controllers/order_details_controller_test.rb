...
class OrderDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_detail" do
    assert_difference("OrderDetail.count") do
      post order_details_url, params: { order_detail: { order_id: @order_detail.order_id, price_at_order: @order_detail.price_at_order, quantity: @order_detail.quantity, watch_id: @order_detail.watch_id } }
    end
  ...
  test "should update order_detail" do
    patch order_detail_url(@order_detail), params: { order_detail: { order_id: @order_detail.order_id, price_at_order: @order_detail.price_at_order, quantity: @order_detail.quantity, watch_id: @order_detail.watch_id } }
